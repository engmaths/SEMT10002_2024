...
if isinstance(test_lines, list):
    ...
    raise ValueError('A list of sensor values was not printed - fix your program!')

# check number if list values is correct
if len(test_lines) == 3:
    print('The correct number of values appear in the list')
else:
    raise ValueError('An incorrect number of values appear in the list - fix your program!')
...
if test_lines[0] == 0.31 and test_lines[1] == 0.3 and test_lines[2] == 0.3:
    ...
    raise ValueError('At least one of the values in the list is incorrect - fix your program!')
...
if os.path.exists(output_filename):
    ...
    with open(output_filename, 'r') as file:
        ...
        if len(file) == 291:
            ...
            raise ValueError('Inorrect number of rows in output file - fix your program!')

        if float(file[0][0]) == 1.33 and float(file[-1][0]) == 0.29:
            print('Correct values in output file')
        else:
            raise ValueError('Inorrect values in output file - fix your program!')

else:
    raise ValueError(f"Cannot find output file: {output_filename} - fix your program!")
